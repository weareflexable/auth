      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex items-center justify-center px-4 py-10 sm:px-6 lg:px-8 sm:py-16 lg:py-24">
          <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
            <h2 className="text-3xl font-bold leading-tight text-accent sm:text-4xl">
              Log in to Dashboard
            </h2>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <div className="mt-2.5 relative text-gray-400 focus-within:text-gray-600">
                    ...
                    <input
                      ...
                      className="block w-full py-4 pl-10 pr-4 text-white placeholder-gray-500 transition-all duration-200 border-b-2 border-b-secondary  bg-transparent focus:outline-none focus:border-white  caret-secondary"
                    />
                  </div>
                </div>
                ...
                <div>
                  <button
                    ...
                    type="submit"
                    className="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200  rounded-md bg-gradient-to-r from-fuchsia-600 to-blue-600 focus:outline-none hover:opacity-80 focus:opacity-80"
                  >
                    Sign in
                  </button>
                </div>
